...
public class CoordinatedUniversalTimeDateResponse extends AISMessage {

	public static AISMessage fromAISMessage(AISMessage aisMessage, String messageBits) {
		CoordinatedUniversalTimeDateResponse stationReport = new CoordinatedUniversalTimeDateResponse();
	...
	public CoordinatedUniversalTimeDateResponse() {
		initialize();
	}
	...
	public String toString() {
		...
		buffer.append("{ \"CoordinatedUniversalTimeDateResponse\": {");
