...
config. BalloonImgPath		= "/scripts/tip_balloon/" // Path to images (border, corners, stem), in quotes. JS 07.06.2014: Made path absolute.
// Sizes of balloon images
config. BalloonEdgeSize		= 5	// Integer - sidelength of quadratic corner images (JS 07.06.2014: 6 -> 5)
