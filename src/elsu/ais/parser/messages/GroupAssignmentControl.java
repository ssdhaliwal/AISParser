...
public class GroupAssignmentControl extends AISMessage {
	...
	private void initialize() {
		...
		getMessageBlocks()
				.add(new PayloadBlock(75, 92, 18, "SW Longitude", "sw_lon", "u", "Same as broadcast type 22"));
		getMessageBlocks()
				.add(new PayloadBlock(93, 109, 17, "SW Latitude", "sw_lat", "u", "Same as broadcast type 22"));
		getMessageBlocks()
