...
public class Interrogation extends AISMessage {
	...
	private void initialize() {
		...
		getMessageBlocks().add(new PayloadBlock(96, 107, 12, "Second slot offset", "offset1_2", "u", "Unsigned integer"));
		...
		getMessageBlocks().add(new PayloadBlock(146, 157, 12, "First slot offset", "offset2_1", "u", "Unsigned integer"));
	...
	public void parseMessage(String message) {
		for (PayloadBlock block : getMessageBlocks()) {
			...
			case 40:
				...
				break;
			case 70:
				setType11(AISMessage.unsigned_integer_decoder(block.getBits()));
				break;
			case 76:
				setOffset11(AISMessage.unsigned_integer_decoder(block.getBits()));
				break;
			case 90:
				setType12(AISMessage.unsigned_integer_decoder(block.getBits()));
				break;
			case 96:
				setOffset12(AISMessage.unsigned_integer_decoder(block.getBits()));
				break;
			case 110:
				setMmsi2(AISMessage.unsigned_integer_decoder(block.getBits()));
				break;
			case 140:
				setType21(AISMessage.unsigned_integer_decoder(block.getBits()));
				break;
			case 146:
				setOffset21(AISMessage.unsigned_integer_decoder(block.getBits()));
				break;
			}
		}
	}
