...
public class CommunicationState_ITDMA {
	...
	public void parseMessage(String message) {
		for (PayloadBlock block : messageBlocks) {
			...
			case 0:
				setIncrement(AISMessage.unsigned_integer_decoder(block.getBits()));
				break;
			case 14:
				setSlots(AISMessage.unsigned_integer_decoder(block.getBits()));
				break;
			case 17:
				setKeep(AISMessage.boolean_decoder(block.getBits()));
				break;
			}
		}
	}
