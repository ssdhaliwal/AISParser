...
public class AidToNavigationReport extends AISMessage {
	...
	private void initialize() {
		messageBlocks.add(new PayloadBlock(0, 5, 6, "Message Type", "type", "u", "Constant: 21"));
		...
		messageBlocks.add(new PayloadBlock(38, 42, 5, "Aid type", "aid_type", "e", "See \"Navaid Types\""));
		messageBlocks.add(new PayloadBlock(43, 162, 120, "Name", "name", "t", "Name in sixbit chars"));
		messageBlocks.add(new PayloadBlock(163, 163, 1, "Position Accuracy", "accuracy", "b", "As in CNB"));
		messageBlocks.add(new PayloadBlock(164, 191, 28, "Longitude", "lon", "I4", "Minutes/10000 (as in CNB)"));
		messageBlocks.add(new PayloadBlock(192, 218, 27, "Latitude", "lat", "I4", "Minutes/10000 (as in CNB)"));
		messageBlocks.add(new PayloadBlock(219, 227, 9, "Dimension to Bow", "to_bow", "u", "Meters"));
		messageBlocks.add(new PayloadBlock(228, 236, 9, "Dimension to Stern", "to_stern", "u", "Meters"));
		messageBlocks.add(new PayloadBlock(237, 242, 6, "Dimension to Port", "to_port", "u", "Meters"));
		messageBlocks.add(new PayloadBlock(243, 248, 6, "Dimension to Starboard", "to_starboard", "u", "Meters"));
		messageBlocks.add(new PayloadBlock(249, 252, 4, "Type of EPFD", "epfd", "e", "As in Message Type 4"));
		messageBlocks.add(new PayloadBlock(253, 258, 6, "UTC second", "second", "u", "As in Message Types 1-3"));
		messageBlocks.add(new PayloadBlock(259, 259, 1, "Off-Position Indicator", "off_position", "b", "See Below"));
		messageBlocks.add(new PayloadBlock(260, 267, 8, "Regional reserved", "regional", "u", "Uninterpreted"));
		messageBlocks.add(new PayloadBlock(268, 268, 1, "RAIM flag", "raim", "b", "As in CNB"));
		messageBlocks.add(new PayloadBlock(269, 269, 1, "Virtual-aid flag", "virtual_aid", "b", "See Below"));
		messageBlocks
				.add(new PayloadBlock(270, 270, 1, "Assigned-mode flag", "assigned", "b", "See [IALA] for details"));
		messageBlocks.add(new PayloadBlock(271, 271, 1, "Spare", "", "x", "Not used"));
		messageBlocks.add(new PayloadBlock(272, -1, 88, "Name Extension", "", "t", "See Below"));
	}
