...
public class T1_PositionReportClassA extends AISMessageBase {
	...
	public String toString() {
		...
		try {
			...
			node.put("statusText", AISLookupValues.getNavigationStatus(getStatus()));
			node.put("rateOfTurn", getRateOfTurn());
			...
			node.put("maneuver", getManeuver());
			node.put("maneuverText", AISLookupValues.getManeuverIndicator(getManeuver()));
